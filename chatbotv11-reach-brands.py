...
ORDER_PATH             = "SP Reach Brands 20250820.xlsx"
ASIN_REPORT_PATH       = "full_detailed_aggregated_report_reach_brands.xlsx"
BRAND_REPORT_PATH      = "full_detailed_aggregated_report_brand_reach_brands.xlsx"
GM_REPORT_PATH         = "full_detailed_aggregated_report_gm_reach_brands.xlsx"
UNDERPER_REPORT       = "underperforming_ats_report_reach_brands.xlsx"
...
def tool_gross_margin_underperformers(_: str) -> str:
    ...
    try:
        ...
        gm_under = pd.read_excel("GM_Underperformers_reach_brands.xlsx")
